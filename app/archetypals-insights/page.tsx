...
// import { archetypalAgentManager } from "@/lib/archetypal-agents"
...
//     const activeArchetypalAgents = archetypalAgentManager.getActiveArchetypalAgents()
//     setAgentStats({
//       activeAgents: activeAgents.length,
//       thoughtsGenerated: 0,
//       councilDecisions: 0,
//       archetypalAgents: activeArchetypalAgents.length,
//       archetypalThoughts: 0,
//     })
//   }, [])
...
//       // Process messages with archetypal agents
//       if (processedMessages.length > 0) {
//         console.log(`🎭 Processing messages with archetypal agents`)
...
//           try {
//             const archetypalThoughts = await archetypalAgentManager.analyzeUserMessage(
//               latestUserMessage.content,
//               latestAssistantMessage.content,
//               latestUserMessage.sessionId || "default",
//             )

//             console.log(`✅ Generated ${archetypalThoughts.length} archetypal thoughts`)

//             // Update stats
//             setAgentStats((prev) => ({
//               ...prev,
//               archetypalThoughts: prev.archetypalThoughts + archetypalThoughts.length,
//             }))
//           } catch (error) {
//             console.error(`❌ Error processing with archetypal agents:`, error)
//           }
//         }
//       }
...
//       anythingLLMIntegration.updateConfig(baseUrl, apiKey)

//       await anythingLLMIntegration.startMonitoring(workspaceId, 30000) // 30 second intervals
...
//                   <li>Analyze messages with archetypal agents (Security, Sales, Marketing, Governance)</li>
...
//                 <div className="text-2xl font-bold">{agentStats.archetypalAgents}</div>
//                 <div className="text-sm text-gray-600">Archetypal Agents</div>
//               </div>

//               <div className="text-center">
//                 <Activity className="h-8 w-8 text-green-600 mx-auto mb-2" />
//                 <div className="text-2xl font-bold">{agentStats.thoughtsGenerated + agentStats.archetypalThoughts}</div>
//                 <div className="text-sm text-gray-600">Total Thoughts Generated</div>
//               </div>
